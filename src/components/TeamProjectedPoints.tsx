...
interface TeamProjectedPointsProps {
...
export function TeamProjectedPoints({
  scorecard,
  selectedPlayerIds,
  captainId,
  viceCaptainId,
}: TeamProjectedPointsProps) {
  if (!scorecard?.length || selectedPlayerIds.length !== 11) return null;
  ...
  return (
    <div className="rounded-xl border border-slate-700 bg-slate-900/50 p-6">
      <h3 className="mb-4 text-lg font-semibold text-white">Your team projected points</h3>
